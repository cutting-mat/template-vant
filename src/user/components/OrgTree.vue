<template>
  ...
  >
    <van-table-column
      ...
      width="45"
    ></van-table-column>
    <van-table-column prop="name" label="名称"></van-table-column>
    <van-table-column prop="fullName" label="全称"></van-table-column>
    <van-table-column label="创建时间">
      <template slot-scope="scope">{{ scope.row.createTime | date }}</template>
    </van-table-column>
    <van-table-column label="操作" width="260">
